    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user.equals("")) {
                    username.setError(getString(R.string.blankPassError));
                } else if (pass.equals("")) {
                    password.setError(getString(R.string.blankPassError));
                } else {
                    ...
                    StringRequest request = new StringRequest(Request.Method.GET, FIREBASE_URL, new Response.Listener<String>() {
                        ...
                        public void onResponse(String s) {
                            if (s.equals("null")) {
                                Toast.makeText(Login.this, USER_NOT_FOUND, Toast.LENGTH_LONG).show();
                            } else {
                                try {
